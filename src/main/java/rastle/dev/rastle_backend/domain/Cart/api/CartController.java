...
public class CartController {
    ...
    @FailApiResponses
    @PostMapping
    public ResponseEntity<ServerResponse<String>> addToCart(@RequestBody List<CreateCartItemDto> createCartItemDtos) {
        cartService.addToCart(createCartItemDtos);
    ...
    public ResponseEntity<ServerResponse<String>> removeSelectedProducts(
            @RequestBody List<DeleteCartItemDto> deleteCartItemDtos) {
        cartService.removeSelectedProducts(deleteCartItemDtos);
