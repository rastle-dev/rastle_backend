...
public class BundleProductInfo {
    ...
    public static BundleProductOutInfo toBundleProductOutInfo(BundleProductInfo bundleProductInfo) {
        return new BundleProductOutInfo(
            bundleProductInfo.getBundleId(),
            bundleProductInfo.getBundleName(),
            bundleProductInfo.getBundleImageUrls(),
            bundleProductInfo.getBundleDescription(),
            bundleProductInfo.getSaleStartTime().toString(),
            bundleProductInfo.isBundleVisible(),
            bundleProductInfo.getProductId(),
            bundleProductInfo.getProductName(),
            bundleProductInfo.getPrice(),
            bundleProductInfo.getMainThumbnail(),
            bundleProductInfo.getSubThumbnail(),
            bundleProductInfo.getDiscountPrice(),
            bundleProductInfo.getDisplayOrder(),
            bundleProductInfo.isProductVisible(),
            bundleProductInfo.isSoldOut(),
            bundleProductInfo.getSoldCount()
        );
    }
    ...
    @AllArgsConstructor
    @NoArgsConstructor
    public static class BundleProductOutInfo {
        @Schema(description = "상품 세트 아이디", defaultValue = "0")
        Long bundleId;
        @Schema(description = "상품 세트 이름", defaultValue = "첫번째 상품 세트")
        String bundleName;
