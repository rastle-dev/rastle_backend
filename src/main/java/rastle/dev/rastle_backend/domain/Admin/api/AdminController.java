...
public class AdminController {
    ...
    @GetExecutionTime
    @PostMapping("/product")
    public ResponseEntity<ServerResponse<?>> createProduct(@RequestBody ProductDTO.ProductCreateRequest createRequest) throws IOException {
    ...
    public ResponseEntity<ServerResponse<?>> uploadMainThumbnail(@PathVariable("id") Long id,
                                                                 @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "등록할 상품 썸네일 이미지")
    ...
    public ResponseEntity<ServerResponse<?>> uploadDetailImages(@PathVariable("id") Long id,
                                                                @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "등록할 상품 이미지들")
    ...
    public ResponseEntity<ServerResponse<?>> createCategory(@RequestBody CategoryDto.CategoryCreateRequest createRequest) {
    ...
    public ResponseEntity<ServerResponse<?>> addImagesToCategory(@PathVariable("id") Long id, @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "등록할 카테고리 이미지들")@RequestParam("images") List<MultipartFile> images) {
